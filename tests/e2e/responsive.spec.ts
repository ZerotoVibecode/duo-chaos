...
test('fits the complete cockpit when windowed and fills a large display', async () => {
  ...
  try {
    ...
    await expectMinimumFontSize(page, '.mode-card small', 11)
    await expectMinimumFontSize(page, '.loadout-agent-identity strong', 12)
    await expectMinimumFontSize(page, '.loadout-agent-identity small', 11)
    await expectMinimumFontSize(page, '.loadout-field > span', 11)
    await expectMinimumFontSize(page, '.loadout-field select', 11)
    await expectMinimumFontSize(page, '.loadout-effective', 11)
    ...
    await expectMinimumFontSize(page, '.system-check strong', 11)
    await expectMinimumFontSize(page, '.readiness-note span', 11)
    ...
    await expectMinimumFontSize(page, '.settings-field span', 11)
    ...
    await expectMinimumFontSize(page, '.agent-metrics span', 11)
    await expectMinimumFontSize(page, '.agent-metrics strong', 11)
    await expectMinimumFontSize(page, '.agent-stance > span', 11)
    await expectMinimumFontSize(page, '.agent-stance p', 12)
    await expectMinimumFontSize(page, '.opinion-agent', 11)
    await expectMinimumFontSize(page, '.opinion-target', 11)
    await expectMinimumFontSize(page, '.tone-pill', 11)
    await expectMinimumFontSize(page, '.opinion-card > p', 12)
    await expectMinimumFontSize(page, '.opinion-data', 11)
    ...
    await expectMinimumFontSize(page, '.terminal-pane > div', 11)
    await expectMinimumFontSize(page, '.terminal-pane > div strong', 11)
