...
test('launches a full Simulation Mode run through the reveal', async () => {
  ...
  await expectMinimumFontSize(page, '.exchange-rail li > span', 11)
  await expectMinimumFontSize(page, '.broadcast-beat h2', 16)
  await expectMinimumFontSize(page, '.broadcast-beat p', 12)
  await expectMinimumFontSize(page, '.broadcast-context p', 11)
  await expectMinimumFontSize(page, '.task-card strong', 11)
  await expectMinimumFontSize(page, '.owner', 11)
  await expectMinimumFontSize(page, '.risk', 11)
  ...
  await expectMinimumFontSize(page, '.reveal-kicker', 11)
