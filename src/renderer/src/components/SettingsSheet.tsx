        ...
        <div className="settings-content">
          ...
          <section>
            ...
            <div className="settings-numbers">
              ...
              <label className="settings-field"><span>Quality routing</span><select value={draft.qualityRoutingProfile} onChange={(event) => update('qualityRoutingProfile', event.target.value as AppSettings['qualityRoutingProfile'])}><option value="balanced">Balanced · Max ceiling, High implementation</option><option value="force-selected">Always use selected effort</option></select></label>
              <label className="settings-field"><span>Claude work inference lease</span><input type="number" min="3" max="20" value={draft.claudeWorkInferenceLimit} onChange={(event) => update('claudeWorkInferenceLimit', Number(event.target.value))} /></label>
            </div>
            ...
            <p className="settings-help">Balanced routing keeps the chosen premium model as the quality ceiling, runs long Claude implementation at High, and reserves premium judgment for bounded evidence review. A work inference lease checkpoints and hands off; it is not a run timeout.</p>
          </section>
